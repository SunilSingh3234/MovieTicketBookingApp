...
const AdminSidebar = () => {
  ...
  return (
    <div className='h-[calc(100vh-64px)] md:flex flex-col pt-8 items-center max-w-13 md:max-w-60 w-full border-r text-sm border-gray-300/20'>
      <img src={user.imageUrl} alt="sidebar" className='h-9 md:h-14 w-9 md:w-14 mx-auto rounded-full' />
